title: [EXT] Registration Unicode
description: EXT: Unicode & Emoji Support in epic/feature "Auth-settings".
test_suite: Auth-settings Extended Regression
Covered requirement: Edge case for Registration Unicode
preconditions:
...
test_level: 2
jira: N/A
Test script: [auth.spec.ts](file:///c:/projects/antigravity_prj/prompthive/tests/e2e/regression/auth.spec.ts)#Verify Registration: Maximal Text Size and Unicode

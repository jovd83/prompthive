title: [ERR] Registration SQLi
description: ERR: SQLi Payload Resilience in epic/feature "Auth-settings".
test_suite: Auth-settings Extended Regression
Covered requirement: Edge case for Registration SQLi
preconditions:
...
test_level: 2
jira: N/A
Test script: [auth.spec.ts](file:///c:/projects/antigravity_prj/prompthive/tests/e2e/regression/auth.spec.ts)#Verify Registration: SQLi Payload Resilience

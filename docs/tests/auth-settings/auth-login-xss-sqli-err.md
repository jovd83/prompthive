title: [ERR] Login XSS & SQLi
description: ERR: Payload Injection Resistance in epic/feature "Auth-settings".
test_suite: Auth-settings Extended Regression
Covered requirement: Edge case for Login XSS & SQLi
preconditions:
...
test_level: 2
jira: N/A
Test script: [auth.spec.ts](file:///c:/projects/antigravity_prj/prompthive/tests/e2e/regression/auth.spec.ts)#Login attempt with XSS & SQLi payloads

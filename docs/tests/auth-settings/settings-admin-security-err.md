title: [ERR] Admin Security Bypass
description: ERR: Direct API Toggle Restriction in epic/feature "Auth-settings".
test_suite: Auth-settings Extended Regression
Covered requirement: Edge case for Admin Security Bypass
preconditions:
...
test_level: 2
jira: N/A
Test script: [settings.spec.ts](file:///c:/projects/antigravity_prj/prompthive/tests/e2e/regression/settings.spec.ts)#Privilege Escalation Attempt: Direct API Toggle for Non-Admin

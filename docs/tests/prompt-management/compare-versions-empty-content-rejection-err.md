title: [ERR] Prompt Management - Empty Content Rejection
description: Verify rejecting empty edits in epic "Prompt Management".
...
test_level: 2
jira: N/A
Test script: [prompts.spec.ts](file:///c:/projects/antigravity_prj/prompthive/tests/e2e/regression/prompts.spec.ts)#Edit Prompt: Empty Content Rejection

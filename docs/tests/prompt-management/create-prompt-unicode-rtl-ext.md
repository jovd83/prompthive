title: [EXT] Prompt Management - Unicode & RTL
description: Verify Emojis and RTL Encoding in epic "Prompt Management".
...
test_level: 2
jira: N/A
Test script: [prompts.spec.ts](file:///c:/projects/antigravity_prj/prompthive/tests/e2e/regression/prompts.spec.ts)#Create Prompt: Unicode, Emojis, and RTL Encoding

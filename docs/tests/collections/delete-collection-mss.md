title: [UI] Collections & Tags - Delete Collection
description: MSS: Delete collection in epic "Collections & Tags".
...
test_level: 1
jira: N/A
Test script: [collections.spec.ts](file:///c:/projects/antigravity_prj/prompthive/tests/e2e/regression/collections.spec.ts)#MSS: Delete collection

...
## Overview
This document describes the updated JSON schema for TMT's export functionality. Version 2 introduces support for hierarchical collections preservation during import/export cycles.

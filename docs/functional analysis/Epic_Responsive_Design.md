...
## 1. Description
The goal of this epic is to ensure TMT provides a seamless and optimized user experience across all device sizes, specifically targeting mobile phones (e.g., iPhone) and tablets (e.g., iPad). Currently, the application is optimized for desktop, leading to layout breaks and usability issues on smaller screens.

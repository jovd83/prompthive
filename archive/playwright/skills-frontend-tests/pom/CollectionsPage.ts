...
export class CollectionsPage {
    ...
    constructor(page: Page) {
        ...
        this.collectionHeader = page.locator('h1');
        this.actionsMenuButton = page.getByLabel('Collection actions');

        // Actions Menu Items
        this.editDetailsMenuItem = page.getByText('Edit Details');
        this.changeMultipleMenuItem = page.getByText('Change multiple...');
        this.deleteCollectionMenuItem = page.getByText('Delete Collection');
        ...
        // Delete Modal
        this.deleteEverythingButton = page.getByRole('button', { name: "Delete Everything" });
    }
